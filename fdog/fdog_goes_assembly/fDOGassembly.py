...
def main():
    ...
    for key in regions:
        ...
        for i in locations:
            ...
            os.system("augustus --protein=1 --codingseq=on --proteinprofile=" + profile_path + " --predictionStart=" + start + " --predictionEnd=" + end + " --species=" + augustus_ref_species + " tmp/" + key + ".fasta > tmp/" + key + "_" + str(counter) + ".gff")
