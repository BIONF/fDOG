...
def main():
    ...
    optional.add_argument('--isoforms', help='If all Isoforms of a gene should be included in the output', action='store_true', default=False)
